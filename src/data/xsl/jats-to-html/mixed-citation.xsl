...
<xsl:stylesheet version="1.0" exclude-result-prefixes="xlink"
    ...
    <xsl:template match="mixed-citation[@publication-type='conf-proceedings']
    ...
    <xsl:template match="mixed-citation[@publication-type='working-paper']">
        <xsl:call-template name="authors-year"></xsl:call-template>
        <cite class="article-title">
            <xsl:apply-templates select="article-title" mode="citation"/>
        </cite>
    ...
    <!-- software citations -->
    <xsl:template match="mixed-citation[@publication-type='software']">
        <xsl:call-template name="authors-year"></xsl:call-template>
        <cite class="article-title">
    ...
    <!-- data citations -->
    <xsl:template match="mixed-citation[@publication-type='data']">
        <xsl:call-template name="authors-year"></xsl:call-template>
        <cite class="article-title">
            <xsl:apply-templates select="data-title" mode="citation"/>
        </cite>
